...
CREATE INDEX IF NOT EXISTS idx_image_assets_document_id ON image_assets(document_id);
CREATE INDEX IF NOT EXISTS idx_image_assets_doc_id ON image_assets(doc_id);
CREATE INDEX IF NOT EXISTS idx_image_assets_page ON image_assets(doc_id, page_number);
...
CREATE INDEX IF NOT EXISTS idx_content_units_document_id ON content_units(document_id);
CREATE INDEX IF NOT EXISTS idx_content_units_doc_id ON content_units(doc_id);
CREATE INDEX IF NOT EXISTS idx_content_units_image_id ON content_units(image_id);
CREATE INDEX IF NOT EXISTS idx_content_units_unit_type ON content_units(unit_type);
CREATE INDEX IF NOT EXISTS idx_content_units_tags ON content_units USING GIN(tags);
CREATE INDEX IF NOT EXISTS idx_content_units_page ON content_units(doc_id, page_number);
